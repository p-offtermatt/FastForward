...
class TSCCExplorationEGAGEF;
/*!
\brief the verification task

This class wraps the potential liveness check by statespace exploration

*/

class EFAGEFTask : public Task
{
public:
	ternary_t result;
    EFAGEFTask();
    ...
    NetState * ns;
    Firelist * fl;
    TSCCExplorationEGAGEF * exploration;
    SimpleProperty * p;
