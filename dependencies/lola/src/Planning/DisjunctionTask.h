...
This class schedules subtasks of a top level disjunction

*/

class DisjunctionTask : public Task
{
public:
	ternary_t result;
        ternary_t subresult1;
        ternary_t subresult2;
    DisjunctionTask(Task*,Task*);
    ~DisjunctionTask();
    ...
    // witnesses, status etc. are left to child processes
    // LCOV_EXCL_START
