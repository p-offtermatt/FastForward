...
# directories
m4_define([TESTFILES],            [/home/local/USHERBROOKE/offp3001/git/a_star/dependencies/lola/tests/testfiles])
m4_define([BENCHRESULTS],         [/home/local/USHERBROOKE/offp3001/git/a_star/dependencies/lola/tests/benchmarks-results])
...
m4_define([LOLA],       [cover.sh /home/local/USHERBROOKE/offp3001/git/a_star/dependencies/lola/src/lola --nolog])
m4_define([LISTENER],   [cover.sh /home/local/USHERBROOKE/offp3001/git/a_star/dependencies/lola/utils/listener])
m4_define([KILLER],     [cover.sh /home/local/USHERBROOKE/offp3001/git/a_star/dependencies/lola/utils/killer])

# the main executable, directly called to allow for analysis
m4_define([LOLA_RAW],  [/home/local/USHERBROOKE/offp3001/git/a_star/dependencies/lola/src/lola --nolog])

# a LoLA call to check the logging functionality
m4_define([LOLA_LOG],  [cover.sh /home/local/USHERBROOKE/offp3001/git/a_star/dependencies/lola/src/lola])
