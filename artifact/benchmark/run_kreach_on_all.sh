...
python3 benchmark.py nets/coverability/* -o results/coverability.json -to $TIMEOUT -t Kosaraju -mode cover
...
python3 benchmark.py nets/random_walk/ -o results/random_walk.json -to $TIMEOUT -t Kosaraju -mode reach
...
python3 benchmark.py nets/sypet/ -o results/sypet.json -to $TIMEOUT -t Kosaraju -mode reach
