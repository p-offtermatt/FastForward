...
javadotawtdotgeomdotEllipse2D >= 1,javadotlangdotObject >= 1 ->
javadotawtdotgeomdotEllipse2D' = javadotawtdotgeomdotEllipse2D-1,
javadotlangdotObject' = javadotlangdotObject-1,
boolean' = boolean+1,
indicator_place_javadotawtdotgeomdotEllipse2D' = indicator_place_javadotawtdotgeomdotEllipse2D+1;

javadotawtdotgeomdotEllipse2D >= 1,double >= 4 ->
javadotawtdotgeomdotEllipse2D' = javadotawtdotgeomdotEllipse2D-1,
double' = double-4,
boolean' = boolean+1,
indicator_place_javadotawtdotgeomdotEllipse2D' = indicator_place_javadotawtdotgeomdotEllipse2D+1;
...
init
java.awt.geom.Ellipse2D=1, java.awt.geom.Rectangle2D=1, java.awt.geom.AffineTransform=0, java.awt.geom.Arc2D$Double=0, java.awt.geom.Arc2D$Float=0, java.awt.geom.Area=0, java.awt.geom.CubicCurve2D$Double=0, java.awt.geom.CubicCurve2D$Float=0, java.awt.geom.Ellipse2D$Double=0, java.awt.geom.Ellipse2D$Float=0, java.awt.geom.GeneralPath=0, java.awt.geom.IllegalPathStateException=0, java.awt.geom.Line2D$Double=0, java.awt.geom.Line2D$Float=0, java.awt.geom.Path2D$Double=0, java.awt.geom.Path2D$Float=0, java.awt.geom.Point2D$Double=0, java.awt.geom.Point2D$Float=0, java.awt.geom.QuadCurve2D$Double=0, java.awt.geom.QuadCurve2D$Float=0, java.awt.geom.Rectangle2D$Double=0, java.awt.geom.Rectangle2D$Float=0, java.awt.geom.RoundRectangle2D$Double=0, java.awt.geom.RoundRectangle2D$Float=0, boolean=0, double=0, int=0, java.lang.Object=0, java.awt.Rectangle=0, java.awt.geom.Point2D=0, indicator_place_java.awt.geom.Rectangle2D=0, java.awt.Shape=0, indicator_place_java.awt.geom.Ellipse2D=0

target
java.awt.geom.Rectangle2D=1,boolean=0,double=0,int=0,java.awt.Rectangle=0,java.awt.Shape=0,java.awt.geom.AffineTransform=0,java.awt.geom.Arc2D$Double=0,java.awt.geom.Arc2D$Float=0,java.awt.geom.Area=0,java.awt.geom.CubicCurve2D$Double=0,java.awt.geom.CubicCurve2D$Float=0,java.awt.geom.Ellipse2D=0,java.awt.geom.Ellipse2D$Double=0,java.awt.geom.Ellipse2D$Float=0,java.awt.geom.GeneralPath=0,java.awt.geom.IllegalPathStateException=0,java.awt.geom.Line2D$Double=0,java.awt.geom.Line2D$Float=0,java.awt.geom.Path2D$Double=0,java.awt.geom.Path2D$Float=0,java.awt.geom.Point2D=0,java.awt.geom.Point2D$Double=0,java.awt.geom.Point2D$Float=0,java.awt.geom.QuadCurve2D$Double=0,java.awt.geom.QuadCurve2D$Float=0,java.awt.geom.Rectangle2D$Double=0,java.awt.geom.Rectangle2D$Float=0,java.awt.geom.RoundRectangle2D$Double=0,java.awt.geom.RoundRectangle2D$Float=0,java.lang.Object=0,indicator_place_java.awt.geom.Ellipse2D>=1,indicator_place_java.awt.geom.Rectangle2D>=1
