...
python3 benchmark.py nets/coverability/* -o results/coverability.json -to $TIMEOUT -t FF-GBFS-qmarkingeq FF-astar-qmarkingeq FF-Dijkstra -mode cover
...
python3 benchmark.py nets/coverability_prepruned/* -o results/coverability_prepruned.json -to $TIMEOUT -t FF-GBFS-qmarkingeq-nopruning FF-astar-qmarkingeq-nopruning FF-Dijkstra-nopruning -mode cover
...
python3 benchmark.py nets/random_walk/ -o results/random_walk.json -to $TIMEOUT -t FF-GBFS-qmarkingeq FF-astar-qmarkingeq FF-Dijkstra -mode reach
...
python3 benchmark.py nets/sypet/ -o results/sypet.json -to $TIMEOUT -t FF-GBFS-qmarkingeq FF-astar-qmarkingeq FF-Dijkstra -mode reach
